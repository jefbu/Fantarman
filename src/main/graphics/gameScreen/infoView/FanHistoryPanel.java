...
public class FanHistoryPanel extends JPanel {
	...
	public FanHistoryPanel(int width, int height) {
	...
	public void fillFanHistoryPanel(Army army) {

		minusFourLeftOverPanel.setPreferredSize(
				new Dimension(width * 15 / 100, height * 8 / 10 * (100 - army.previousFanSatisfaction[0]) / 100));
		minusFourSatisfactionPanel.setPreferredSize(
				new Dimension(width * 15 / 100, height * 8 / 10 * army.previousFanSatisfaction[0] / 100));
		minusFourSatisfactionPanel.setBackground(new Color(70, army.previousFanSatisfaction[0], 0));
		
		minusFourTotalPanel.revalidate();
		minusFourTotalPanel.repaint();
		
		minusThreeLeftOverPanel.setPreferredSize(
				new Dimension(width * 15 / 100, height * 8 / 10 * (100 - army.previousFanSatisfaction[1]) / 100));
		minusThreeSatisfactionPanel.setPreferredSize(
				new Dimension(width * 15 / 100, height * 8 / 10 * army.previousFanSatisfaction[1] / 100));
		minusThreeSatisfactionPanel.setBackground(new Color(70, army.previousFanSatisfaction[1], 0));
		
		minusThreeTotalPanel.revalidate();
		minusThreeTotalPanel.repaint();
		
		minusTwoLeftOverPanel.setPreferredSize(
				new Dimension(width * 15 / 100, height * 8 / 10 * (100 - army.previousFanSatisfaction[2]) / 100));
		minusTwoSatisfactionPanel.setPreferredSize(
				new Dimension(width * 15 / 100, height * 8 / 10 * army.previousFanSatisfaction[2] / 100));
		minusTwoSatisfactionPanel.setBackground(new Color(70, army.previousFanSatisfaction[2], 0));
		
		minusTwoTotalPanel.revalidate();
		minusTwoTotalPanel.repaint();
		
		minusOneLeftOverPanel.setPreferredSize(
				new Dimension(width * 15 / 100, height * 8 / 10 * (100 - army.previousFanSatisfaction[3]) / 100));
		minusOneSatisfactionPanel.setPreferredSize(
				new Dimension(width * 15 / 100, height * 8 / 10 * army.previousFanSatisfaction[3] / 100));
		minusOneSatisfactionPanel.setBackground(new Color(70, army.previousFanSatisfaction[3], 0));

		minusOneTotalPanel.revalidate();
		minusOneTotalPanel.repaint();
		
		currentLeftOverPanel.setPreferredSize(
				new Dimension(width * 15 / 100, height * 8 / 10 * (100 - army.fanSatisfaction) / 100));
		currentSatisfactionPanel.setPreferredSize(
				new Dimension(width * 15 / 100, height * 8 / 10 * army.fanSatisfaction / 100));
		currentSatisfactionPanel.setBackground(new Color(70, army.fanSatisfaction, 0));
