...
import main.entity.captains.wanmen.Kluso;
...
import main.entity.captains.wanmen.Sisni;
...
public class Wanmen extends Army {
	...
	public Wanmen() {
		...
		roster.add(new Glasscannon("Sek Skra", new Kluso(), Lieutenant.errant, Lieutenant.musician));
