...
import main.entity.captains.society.Mattressa;
import main.entity.captains.society.Vacumus;
...
public class MulticulturalSociety extends Army {
	...
	public MulticulturalSociety() {
		...
		roster.add(new StoutOfHeart("Piknin Heavies", new Mattressa(), Lieutenant.surgeon, Lieutenant.medic));
		...
		roster.add(new Praetoriae("Feod Cavalry", new Vacumus(), Lieutenant.sergeant, Lieutenant.ambusher,
				Lieutenant.medic));
