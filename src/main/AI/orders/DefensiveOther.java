...
public class DefensiveOther {
	...
	public static void giveOrders(Regiment regiment) {
		...
		case 4:
			...
			regiment.instructions.get(2).condition = Condition.After_1_Turn;
			...
			regiment.instructions.get(3).order = Order.FIRE;
			break;
			
		default:
			System.out.println("Error at Defensive Other AI orders, " + regiment.captain.orders + " orders found");
