...
public abstract class DefensiveArcher {
	...
	public static void giveOrders(Regiment regiment) {
		...
		case 4:
			...
			regiment.instructions.get(2).condition = Condition.Life_under_100;
			regiment.instructions.get(2).target = Target.SELF;
			regiment.instructions.get(2).order = Order.RECOVER;
		...
		default:
			System.out.println("Error at Defensive Archer AI orders, " + regiment.captain.orders + " orders found");
